...
[Mapping adequacies: explicit guidance for pragmatists, corner cutters, and the impatient](mapping-adequacies.md)
  * by [Juan Caballero]("mailto:caballerojuan_AT_pm.me")
  * A set of heuristics meant to assist in documenting best and not-best practices with explicit, nonjudgmental detail 
  * #documentation #bestpractices #otherpractices #ssi-lite
